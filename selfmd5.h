...
typedef struct elf
{
  Elf64_Ehdr      ehdr;
  Elf64_Phdr      phdrs[1];
  unsigned char   text[394];
  unsigned char   _end[6];
} elf;
...
elf foo =
{
  ...
  /* text */
  {
    ...
    0x54, 0x32, 0x10, 0x48, 0x89, 0x44, 0x24, 0x18, 0xC6, 0x04, 0x25, 0xF2,
    0x01, 0x40, 0x00, 0x80, 0x48, 0xC7, 0x04, 0x25, 0xF8, 0x01, 0x40, 0x00,
    0x90, 0x0F, 0x00, 0x00, 0x8B, 0x6C, 0x24, 0x10, 0x44, 0x8B, 0x54, 0x24,
    ...
    0xFE, 0xD9, 0xE1, 0xD8, 0x0D, 0xB1, 0x00, 0x00, 0x00, 0x48, 0x0F, 0xBE,
    ...
    0x24, 0x1C, 0x48, 0x81, 0xFB, 0x00, 0x02, 0x00, 0x00, 0x0F, 0x85, 0x11,
    ...
    0x20, 0x48, 0x8D, 0x74, 0x24, 0x20, 0xB2, 0x01, 0xFF, 0xC3, 0xBF, 0x01,
    0x00, 0x00, 0x00, 0xB0, 0x01, 0x0F, 0x05, 0x80, 0xFB, 0x20, 0x75, 0xBD,
    0x31, 0xFF, 0xB0, 0x3C, 0x0F, 0x05, 0x00, 0x00, 0x80, 0x4F
  },
  /* _end */
  { }
};
